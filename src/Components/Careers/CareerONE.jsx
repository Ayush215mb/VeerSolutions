    ...
    <div className="flex  mt-10 flex-col  items-center justify-center">
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-10 md:gap-32">
        ...
        <div className="flex flex-col gap-5 md:gap-10">
          <h1 className="md:text-5xl md:font-bold font-semibold text-sm">
            Join Veer Solutions
          </h1>
          <div className="flex flex-col gap-2 md:gap-7 items-left justify-center">
            <p className="flex md:items-center items-start gap-2  md:gap-4  text-sm md:text-3xl">
              <AiOutlineCaretRight className=" text-sm sm:text-md text-red-500 md:text-xl" />
              Flexible Work Schedule
            </p>
            <p className="flex  md:items-center items-start gap-2 md:gap-4 text-sm sm:text-md  md:text-3xl">

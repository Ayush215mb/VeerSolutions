  ...
  return (
    <div className="flex  mt-10 flex-col  items-center justify-center">
      ...
      <motion.div className="flex flex-col items-center gap-5 py-12 border-t  md:mx-28 md:my-20  border-gray-800 md:py-16">
        ...
        <a href="mailto:veer.149610@gmail.com?subject=Hello there, I am {name}&body=I am applying for {*****} position as a Part-time/ Full-time/Internship and I have attached my resume/portfolio in this mail">
          <motion.button

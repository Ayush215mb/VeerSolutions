...
<h1 className="text-xl font-bold text-center mb-5 mt-10">Mirage</h1>
<img
  src="https://www.westchain.org/_next/image?url=%2Fprojects%2Fhubbleprotocol.png&w=1920&q=75"
  alt="pebble-img"
...
/>
<div>
  <p className="max-w-72 text-md my-5 text-start">
    Hubble is a decentralized finance (DeFi) platform on the Solana
    blockchain that allows users to borrow USDH using various assets as
    collateral. This enables users to unlock liquidity from their
    long-term investment tokens.
  </p>
  <h3 className="text-start text-xl font-semibold">Softwares Used:</h3>
  <p className="max-w-72 text-md my-5 text-start">
    <ul>
      <li>DeFi</li>
      <li>Solidity</li>
...
<div className="flex border-t my-5 border-slate-800  flex-col items-center ">
<h1 className="text-xl font-bold text-center mb-5 mt-10">
  Waxel World
</h1>
<img
  src="https://www.westchain.org/_next/image?url=%2Fprojects%2Fwaxel.png&w=1920&q=75"
...
<div>
  <p className="max-w-72 text-md my-5 text-start">
    Waxel World is an NFT game on the WAX blockchain, derived from the
    beloved Waxel Ninjas NFT Collection. Engage in Waxel World and take
    ownership of NFTs!
  </p>
  <h3 className="text-start text-xl font-semibold">Softwares used:</h3>
  <p className="max-w-72 text-md my-5 text-start">
